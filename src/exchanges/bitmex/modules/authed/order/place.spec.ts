...
describe(__filename, () => {
  ...
  it('should place a Bitmex limit order just fine', async () => {
    ...
    const translatedOrderSide = translateOrderSideToBitmex({ from: side })
    const translatedOrderType = translateOrderTypeToBitmex({ from: type })
    ...
    const body = {
      ...
      rate: 0,
      // limit: 0,
      // timeInForce: BitmexOrderTimeInForceEnum.GOOD_TIL_CANCELLED,
    }
  ...
  it('should place a Bitmex market order just fine', async () => {
    ...
    const body = {
      ...
      quantity: 0.01,
      rate: 0,
      // timeInForce: BitmexOrderTimeInForceEnum.FILL_OR_KILL,
    }
  ...
  it(
    'should throw an error placing for minimum size placing new bitmex order',
    async () => {
  ...
  it('should throw an error placing new bitmex order', async () => {
