...
export const SAMPLE_RAW_MARKET_SUMMARIES: ISampleMarketSummarySchema[] = [
  {
    symbol: 'BTC-EUR',
    high: '33296.36600000',
    low: '31790.00000000',
...
export const SAMPLE_RAW_MARKET_TICKERS: ISampleMarketTickerSchema[] = [
  {
    symbol: 'BTC-EUR',
...
export const SAMPLE_RAW_MARKETS_INFO: ISampleMarketInfoSchema[] = [
  {
    symbol: 'BTC-EUR',
...
export const SAMPLE_RAW_MARKET: ISampleMarketSchema = {
  marketInfo: SAMPLE_RAW_MARKETS_INFO[0],
  summary: SAMPLE_RAW_MARKET_SUMMARIES[0],
  ticker: SAMPLE_RAW_MARKET_TICKERS[0],
}

export const SAMPLE_RAW_MARKETS: ISampleMarketsSchema = {
  marketsInfo: SAMPLE_RAW_MARKETS_INFO,
  summaries: SAMPLE_RAW_MARKET_SUMMARIES,
  tickers: SAMPLE_RAW_MARKET_TICKERS,
}

export const SAMPLE_PARSED_MARKETS: IAlunaMarketSchema[] = [
  {
    exchangeId: 'sample',
    symbolPair: 'BTC-EUR',
    baseSymbolId: 'BTC',
